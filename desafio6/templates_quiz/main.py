...
opcion = validate(['0', '1'], input('''Ingrese una opción para Jugar! 
        1. Jugar
        0. Salir
        
    > '''))
# 1. validar opcion
# Se incorpora metodo validate() a opcion para confirmar que los datos ingresados sean validos. ["0", "1"]
...
if opcion == '0':
    ...
    os.system(op_sys)
    # finalizar programa
    sys.exit() #se incorpora esta funcion para detener el programa definitivamente cuando la opcion sea "0"
...
while correcto and n_pregunta < 3*p_level:
    ...
    if continuar == 'y':
        ...
        correcto = alternativas[respuesta - 1][1] == 1
